...
class Product extends ChangeNotifier {
  ...
  Product({this.id, this.name, this.description, this.images, this.sizes,
    this.deleted = false,this.dataAgenda,this.loja}){
    images = images ?? [];
    sizes = sizes ?? [];
  }
  ...
  Product.fromDocument(DocumentSnapshot document){
    ...
    dataAgenda = document['data'] as String;
    loja = document['loja'] as String;
  }
...
ProductScreen pscreen;
  ...
  @override
  String toString() {
    return 'Product{id: $id, name: $name, description: $description, images: $images, sizes: $sizes, newImages: $newImages, dataAgenda: $dataAgenda, loja: $loja}';
  }
}